...
def parse_args():
    parser = argparse.ArgumentParser(description="Run clustering detection on a KITTI LiDAR frame.")
    parser.add_argument("--data-root", default="data/kitti", help="KITTI root containing training/velodyne.")
...
if __name__ == "__main__":
    ...
    output_path = output_dir / f"kitti_clustering_{frame_id}.png"
